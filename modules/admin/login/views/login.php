...
<div class="relative">
    <div class="absolute right-0 bottom-0  flex items-center max-w-max p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
        ...
        <div>
            <?php
                foreach ($_SESSION['errors'] as $field=>$error) {
                    foreach ($error as $e) {
                        echo '<span class="font-medium">'.$field.' : </span>'.$e .'<br>';
                    }
            }
            ?>
